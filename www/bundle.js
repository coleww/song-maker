...
},{"./demoSong":2,"./processtab":46,"dj-snazzy-snare":4,"int2freq":5,"merge":16,"openmusic-slider":35,"pick-random":36,"pie-ano":37,"really-hi-hat":38,"scale-select":40,"sparkle-motion":42,"spiderbite":43,"tom-from-space":44,"touch-down-dance":45}],2:[function(require,module,exports){
module.exports={
  instruments: {
    //     kick: {
    //   config: {
...
},{"a-d-s-r":3,"make-distortion-curve":15,"midiutils":18}],43:[function(require,module,exports){
function pick (arr) {
  // console.log(arr)
...
},{"a-d-s-r":3,"make-distortion-curve":15}],45:[function(require,module,exports){
var adsr = require('a-d-s-r')
var makeDistortionCurve = require('make-distortion-curve')
module.exports = function (ac, opts) {
  var audioNodes = {
...
},{"a-d-s-r":3,"make-distortion-curve":15}],46:[function(require,module,exports){
